...
import {createReferralLink, getRefferalData} from '../../../Redux/Reducers/settings'
...
function Referral(props) {
    ...
    return <div className="referral-container">
        ...
        <DropDown dropDownOptions={props.linkTypes} selectOption={selectLinkType} placeholder={linkType}
                  defaultPlaceholder='Choose link type'/>
