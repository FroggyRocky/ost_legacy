...
const AdminCreateAcc = (props) => {
    ...
    const [accountState, setAccountState] = useState(props.account ? {
        ...
        userId: props.account.userId ? props.account.userId : '', /*selfie: props.account.selfie,*/
    ...
    function handlePaste(event) {
        ...
        setAccountState({
            ...accountState, proxy_ip: pastedValue[0], proxy_login: pastedValue[1], proxy_password: pastedValue[2]
        });
    }
    ...
    return (<form className='create-account' onSubmit={handleClick}>
        ...
        <div className='create-account-section'>
            ...
            </> : <div onClick={() => setShowMore(true)} className='create-account-show-more'>Show more</div>}
        </div>
        {/*<Form.Group as={Row}>
